...
func registerFeedbacks(router *gin.RouterGroup) {
    ...
    router.GET("/entries/:entryId/feedbacks/:id", ctr.view)
    router.POST("/entries/:entryId/feedbacks", ctr.create)
    router.PUT("/entries/:entryId/feedbacks/:id", ctr.update)
    router.DELETE("/entries/:entryId/feedbacks/:id", ctr.delete)
}
